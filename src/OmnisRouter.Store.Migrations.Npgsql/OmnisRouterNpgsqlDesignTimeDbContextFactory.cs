...
namespace OmnisRouter.Store.Migrations.Npgsql;
...
/// </summary>
public sealed class OmnisRouterNpgsqlDesignTimeDbContextFactory : IDesignTimeDbContextFactory<OmnisRouterDbContext>
{
    public OmnisRouterDbContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql(
            "Host=localhost;Database=omnisrouter_designtime",
            npgsql => npgsql.MigrationsAssembly(
                typeof(OmnisRouterNpgsqlDesignTimeDbContextFactory).Assembly.GetName().Name));
