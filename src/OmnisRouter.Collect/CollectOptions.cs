...
/// <summary>Engine-only options: what to read and how to loop. No endpoint/key (that is the sink's job).</summary>
public sealed record CollectEngineOptions(string Root, DateTimeOffset? Since, int Batch, bool Watch, int Interval);
